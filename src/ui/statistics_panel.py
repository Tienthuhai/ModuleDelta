...
class StatisticsPanel(ctk.CTkFrame):
    ...
    def __init__(self, master, **kwargs):
        ...
        self.lbl_total_title = ctk.CTkLabel(
            self.card_total, text=self._texts["stat_total"],
            font=ctk.CTkFont(size=11)
        )
        self.lbl_total_title.pack(pady=(5, 0))

        self.lbl_total_val = ctk.CTkLabel(
            self.card_total, text="0",
            text_color="#2196F3", font=ctk.CTkFont(size=24, weight="bold")
        )
        ...
        self.lbl_sent_title = ctk.CTkLabel(
            self.card_sent, text=self._texts["stat_sent"],
            font=ctk.CTkFont(size=11)
        )
        self.lbl_sent_title.pack(pady=(5, 0))

        self.lbl_sent_val = ctk.CTkLabel(
            self.card_sent, text="0",
            text_color="#4CAF50", font=ctk.CTkFont(size=24, weight="bold")
        )
        ...
        self.lbl_rejected_title = ctk.CTkLabel(
            self.card_rejected, text=self._texts["stat_rejected"],
            font=ctk.CTkFont(size=11)
        )
        self.lbl_rejected_title.pack(pady=(5, 0))

        self.lbl_rejected_val = ctk.CTkLabel(
            self.card_rejected, text="0",
            text_color="#f44336", font=ctk.CTkFont(size=24, weight="bold")
        )
    ...
    def apply_lang(self, texts: dict):
        ...
        self._texts = texts
        self.title_label.configure(text=texts["stat_title"])
        self.lbl_total_title.configure(text=texts["stat_total"])
        self.lbl_sent_title.configure(text=texts["stat_sent"])
        self.lbl_rejected_title.configure(text=texts["stat_rejected"])
